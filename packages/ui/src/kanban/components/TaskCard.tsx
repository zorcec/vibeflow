  ...
  return (
    ...
    >
      ...
      <div style={CARD_TITLE_ROW_STYLE}>
        {isInProgress && (
          <span className="spinner" style={SPINNER_SHRINK_STYLE} />
        )}
      ...
      {(task.description || thumbnailUrl) && (
        <div style={DESC_THUMB_ROW_STYLE}>
          {task.description && (
            <div style={DESC_TEXT_STYLE}>{task.description}</div>
          )}
          {thumbnailUrl && (
            <div
                ...
                ReactDOM.createPortal(
                  <img
                    ...
                    style={{
                      ...
                      objectFit: "cover",
                      border:
                        "1px solid color-mix(in srgb, var(--p-border) 96%, transparent)",
                      boxShadow:
      ...
      <div className="flex items-center" style={CARD_FOOTER_STYLE}>
        ...
        <CardIconButton
          ...
          title={
            commentCount > 0 ? `${commentCount} comment(s)` : "Add comment"
          }
